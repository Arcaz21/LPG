                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
			              <div class="col-md-12 col-sm-12 col-xs-12">
			                <div class="x_panel">
			                  <div class="x_title">
			                    <h2>Register Client<small>Register client here!</small></h2>
			                    ...
			                    <form action="<?php $_PHP_SELF ?>" method="POST" data-parsley-validate="" class="form-horizontal form-label-left" >
			                      ...
			                      <div class="item form-group">
			                        ...
			                        <div class="col-md-6 col-sm-6 col-xs-12">
			                          <input name="vendname" class="form-control col-md-7 col-xs-12" data-validate-length-range="12" placeholder="Cassandra Melvin" required="required" type="text" >
			                        </div>
			                      </div>
                                  ...
                                  <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input required="" name="vendcomp" class="form-control col-md-7 col-xs-12" data-validate-length-range="12"  type="text" >
                                    </div>
                                  </div>
                                  <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input required="" name="vendadd" class="form-control col-md-7 col-xs-12" data-validate-length-range="30"  type="text" >
                                    </div>
                                  </div>
			                      <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input required="" placeholder="ex. 09123458749" type="number" id="number" name="vendcon" data-validate-length-range="11" class="form-control col-md-7 col-xs-12" >
                                    </div>
			                      </div>
			                      <div class="ln_solid"></div>
			                      <div class="form-group">
			                        <div class="col-md-6 col-md-offset-3">
                                        <input hidden="hidden" name="add" value="Add Client" >
