                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
			              <div class="col-md-12 col-sm-12 col-xs-12">
			                <div class="x_panel">
			                  <div class="x_title">
			                    <h2>Add Product<small>Add products here!</small></h2>
			                    ...
			                    <form action="<?php $_PHP_SELF ?>" method="POST" class="form-horizontal form-label-left" novalidate="">
			                      ...
			                      <div class="item form-group">
			                        ...
			                        <div class="col-md-6 col-sm-6 col-xs-12">
			                          <input name="prodname" class="form-control col-md-7 col-xs-12" data-validate-length-range="12" placeholder="e.g. LPG" required="required" type="text" >
			                        </div>
			                      </div>
                                  ...
                                  <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input name="description" class="form-control col-md-7 col-xs-12" data-validate-length-range="12" placeholder="fr. LPG Package e.g. Pryce LPG with Stove" type="text" >
                                    </div>
                                  </div>
			                      <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input type="number" id="number" name="weight" data-validate-minmax="10,100" placeholder="for LPG Only" class="form-control col-md-7 col-xs-12" >
                                    </div>
			                      </div>
                                  <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input type="number" id="number" name="serial" data-validate-minmax="10,100" placeholder="e.g. 753951684NGBD58 " class="form-control col-md-7 col-xs-12" >
                                    </div>
                                  </div>
			                      <div class="item form-group">
			                        ...
			                        <div class="col-md-6 col-sm-6 col-xs-12">
			                          <input type="number" id="number" name="qty" required="required" data-validate-minmax="1,10000" class="form-control col-md-7 col-xs-12" >
			                        </div>
			                      </div>
                                  <div class="item form-group">
			                      ...
			                      <div class="form-group">
			                        <div class="col-md-6 col-md-offset-3">
                                        <input hidden="hidden" name="add" value="Add Product" >
